...
public class HardActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng arthurSeat  = new LatLng( 55.9398, -3.1572);
        mMap.addMarker(new MarkerOptions().position(arthurSeat).title("Arthur\'s seat"));

        LatLng edinburghDungeon  = new LatLng( 55.948612, -3.200833);
        mMap.addMarker(new MarkerOptions().position(edinburghDungeon).title("Edinburgh Dungeon"));
    }
